...
The code for the framework is handled via its [GitHub Repository](https://github.com/themehybrid/hybrid-contracts).  You can open tickets, create patches, and send pull requests there.
